...
function YourLists({ userData }: { userData: UserData }) {
  ...
  return (
    <UserListContainer>
      ...
      <Splide options={{ perPage: 1, arrows: true, autoplay: true, lazyLoad: true, width:"45vw" ,wheel: true, margin:"0.5rem"}}>
      {userData && userData.userLists && userData.userLists.length > 0 ? (
        userData.userLists.map((list, index) => (
          ...
          width: "30vw" ,backgroundColor: "#fafafa", borderRadius: "1rem", padding: "0rem 2rem 0rem 2rem"}}>
